...
export const I18N = {
  en: {
    ...
    channelShare: 'Channel Share', deviceShare: 'Device Share', projectShare: 'Project Share', thisMonth: 'This Month',
  ...
  zh: {
    ...
    channelShare: '渠道占比', deviceShare: '设备占比', projectShare: '项目占比', thisMonth: '本月',
    otherProjects: '其余项目', emptyWindow: '无项目窗口',
